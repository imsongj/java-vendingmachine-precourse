...
- [x] 자판기가 보유하고 있는 금액을 입력받는다.
  - 예외처리 : 숫자가 아닌 입력, 정수 범위를 넘어가는 입력
- [x] 자판기가 보유하고 있는 금액으로 동전을 무작위로 생성한다.
  - 500원, 100원, 50원, 10원 동전을 사용한다.
- [x] 자판기가 보유한 동전을 출력한다.
- [x] 상품명과 가격, 수량을 입력받는다.
  - 상품명, 가격, 수량은 쉼표로, 개별 상품은 대괄호로 묶어 세미콜론으로 구분한다. 
  - 상품 가격은 100원부터 시작하며, 10원으로 나누어떨어져야 한다.
  - 예외처리 : 포멧이 틀린 입력, 상품 가격이 잘못된 입력, 중복된 상품명 입력
- [x] 투입 금액을 입력받는다. 
  - 예외처리 : 숫자가 아닌 입력, 정수 범위를 넘어가는 입력
- [x] 남은 투입 금액을 출력한다.
- [x] 구매할 상품명을 입력받는다.
  - 예외처리 : 자판기에 존재하지않는 상품명 입력, 수량이 0인 상품명 입력, 투입 금액으로 살 수 없는 상품명 입력
- [x] 상품을 구매한다.
  - 상품의 수량에서 1을 빼고 투입 금액에서 삼품 가격을 뺀다.
- [x] 남은 금액이 상품의 최저 가격보다 적거나, 모든 상품이 소진됐는지 확인한다.
- [ ] 잔돈을 출력한다.
  - 잔돈을 다 반환할 수 없는 경우 반환할수 있는 금액만 반환한다.
